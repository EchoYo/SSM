...
jQuery(document).ready(function(){
	...
	jQuery(document).on('click','.stdtablecb .checkall',function(){
	...
	jQuery(document).on('click','.stdtablecb tbody input[type=checkbox]',function(){
		if(jQuery(this).is(':checked')) {
			jQuery(this).parents('tr').addClass('selected');	
		} else {
			jQuery(this).parents('tr').removeClass('selected');
	...
	jQuery(document).on('click','.stdtable a.delete',function(){
	...
	jQuery(document).on('click','.stdtable a.toggle',function(){
	...
	jQuery(document).on('click','.toggledata button.cancel, .toggledata button.submit',function(){
